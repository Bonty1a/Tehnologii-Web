...
bx.viewer  = function()
{
    ...
    on.init = function() 
    {
        images.download(function() 
        {
            ...
            var clickEnd   = on.isMobile ? 'touchend'   : 'click';
            var clickStart = on.isMobile ? 'touchstart' : 'click';
...
$(document).ready(function()
{
    ...
    $(document.body).on(bx.viewer.isMobile ? 'touchstart' : 'click', '[data-toggle="modal"]', function ( e )
    {       
        e.preventDefault();
    ...
    $(document.body).on(bx.viewer.isMobile ? 'touchstart' : 'click', '[data-toggle="ajax"]', function ( e )
    {
        e.preventDefault();
